# Generated by Django 5.0.9 on 2025-05-05 13:55
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('sharedServices', '0102_tariffelements_tariffs_stationconnector_tariff_ids_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_updated', models.DateTimeField()),
                ('evse_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sharedServices.evse')),
            ],
        ),
        ...
        migrations.AddField(
            model_name='evse',
            name='location_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sharedServices.location'),
        ),
        migrations.AddConstraint(
